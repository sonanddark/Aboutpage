...
const WinkSection = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <div ref={ref} className="max-w-[1215.54px] mx-auto mt-[100px] mb-[120px] border-[0.5px] border-[#1D1E1C]">
        ...
        <div className="w-[72%] ">
          <div className="w-[90%] mx-auto py-[60px]">
            ...
            <p className="text-[18px] font-[500] ml-[12px] mt-[16px]">
              1. close and open one eye quickly, typically to indicate that something is a joke or a secret or as
              signal of affection or greeting."he winked at Nicole as he passed"
            </p>
            <p className="text-[18px] font-[500] ml-[12px] mt-[80px]">
              2. (of a bright object or a light) or flash intermittently. <br /> "the diamond on her finger winked in
              the moonlight"
            </p>
          </div>
